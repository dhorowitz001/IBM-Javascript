...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
        document.getElementById('employeeDetails').innerHTML =
            `<p>${foundEmployee.id}: ${foundEmployee.name} - ${foundEmployee.department} -
...
function findEmployeeBySpecialization(employeeSpecialization) {
    ...
    if (specializedEmployee) {
        document.getElementById('employeeDetails').innerHTML =
            `<p>${specializedEmployee.id}: ${specializedEmployee.name} - ${specializedEmployee.department} -
            ${specializedEmployee.specialization} - ${specializedEmployee.salary}</p>`
    } else {
        document.getElementById('employeeDetails').innerHTML = 
